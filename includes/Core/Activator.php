...
class Activator {
    ...
    public static function activate() {
        ...
        $sql_services = "CREATE TABLE {$table_services} (
            ...
            description TEXT DEFAULT NULL,
            type ENUM('session', 'package', 'subscription', 'one_time', 'duration', 'online', 'face_to_face', 'group', 'consultation') DEFAULT 'session' COMMENT 'session=single session, package=session package, subscription=recurring, one_time=single payment, duration=time-based, online=online session, face_to_face=in-person session, group=group session, consultation=consultation',
            ...
            capacity INT DEFAULT 1 COMMENT 'Kontenjan',
            is_active TINYINT(1) DEFAULT 1,
