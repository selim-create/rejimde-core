...
class Activator {
    ...
    public static function activate() {
        ...
        $sql_services = "CREATE TABLE {$table_services} (
            ...
            description TEXT DEFAULT NULL,
            type ENUM('session', 'package', 'subscription', 'one_time', 'duration') DEFAULT 'session' COMMENT 'session=single session, package=session package, subscription=recurring, one_time=single payment, duration=time-based (1 month, 3 months, etc)',
